 ...
 * <ul>
 *   <li>{@link at.fhj.androidapp.androidapp.impl.MIntentImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MIntentImpl extends MinimalEObjectImpl.Container implements MIntent {
	...
	protected EClass eStaticClass() {
		return AndroidApplicationModelPackage.Literals.MINTENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AndroidApplicationModelPackage.MINTENT__NAME, oldName, name));
	}
