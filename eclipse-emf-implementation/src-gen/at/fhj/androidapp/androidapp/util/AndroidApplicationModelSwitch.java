 ...
 * @generated
 */
public class AndroidApplicationModelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public AndroidApplicationModelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AndroidApplicationModelPackage.MANDROID_APP_PROJECT: {
				MAndroidAppProject mAndroidAppProject = (MAndroidAppProject)theEObject;
				T result = caseMAndroidAppProject(mAndroidAppProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AndroidApplicationModelPackage.MAPPLICATION: {
				MApplication mApplication = (MApplication)theEObject;
				T result = caseMApplication(mApplication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AndroidApplicationModelPackage.MPERMISSION: {
				MPermission mPermission = (MPermission)theEObject;
				T result = caseMPermission(mPermission);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AndroidApplicationModelPackage.MINTENT: {
				MIntent mIntent = (MIntent)theEObject;
				T result = caseMIntent(mIntent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AndroidApplicationModelPackage.MINTENT_STARTABLE: {
				MIntentStartable mIntentStartable = (MIntentStartable)theEObject;
				T result = caseMIntentStartable(mIntentStartable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AndroidApplicationModelPackage.MACTIVITY: {
			...
			case AndroidApplicationModelPackage.MSERVICE: {
			...
			case AndroidApplicationModelPackage.MBROADCAST_RECEIVER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>MAndroid App Project</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>MAndroid App Project</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMAndroidAppProject(MAndroidAppProject object) {
		return null;
	}
