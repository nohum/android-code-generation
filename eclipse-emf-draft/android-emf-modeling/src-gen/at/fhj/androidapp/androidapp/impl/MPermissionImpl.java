 ...
 * <ul>
 *   <li>{@link at.fhj.androidapp.androidapp.impl.MPermissionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MPermissionImpl extends MinimalEObjectImpl.Container implements MPermission {
	...
	protected EClass eStaticClass() {
		return AndroidApplicationModelPackage.Literals.MPERMISSION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AndroidApplicationModelPackage.MPERMISSION__NAME, oldName, name));
	}
