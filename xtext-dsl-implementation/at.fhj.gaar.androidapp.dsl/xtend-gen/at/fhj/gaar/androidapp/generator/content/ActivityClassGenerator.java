...
public class ActivityClassGenerator extends AbstractClassGenerator {
  ...
  protected String retrieveElementTemplate(final Application application, final ApplicationElement element) {
    ...
    String _javaToAndroidIdentifier = this.javaToAndroidIdentifier(_name_3);
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public static void openActivity(Context context) {");
    _builder.newLine();
    _builder.append("    \t");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("    \t");
    _builder.append("intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("context.startActivity(intent);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
  ...
  private String insertActionCode(final Activity activity, final ButtonActionAttribute action) {
    ...
    if ((concreteAction instanceof ActionShowToast)) {
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("Toast.makeText(this, getString(R.string.");
